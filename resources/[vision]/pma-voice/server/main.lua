...
local maxChannels = GetConvarInt('sv_maxclients', 350) + 10
local mappedChannels = {}
function firstFreeChannel()
    local newMax = GetConvarInt('sv_maxclients', 350) + 10
...
function GetStateMicrophone(source)
	local plyState = Player(source).state
...
exports('GetPlayersInRadioChannel', getPlayersInRadioChannel)
exports('getStateMicrophone', GetStateMicrophone)
exports('GetStateMicrophone', GetStateMicrophone)