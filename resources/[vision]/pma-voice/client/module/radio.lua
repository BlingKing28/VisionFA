	...
	if not radioPressed and radioEnabled then
		if radioChannel > 0 then
			...
			if GetConvarInt('voice_enableRadioAnim', 0) == 1 and
				...
				if exports["core"]:GetJobPlayer() == "lspd" or exports["core"]:GetJobPlayer() == "ems" or exports["core"]:GetJobPlayer() == "lsfd" or exports["core"]:GetJobPlayer() == "bp" or exports["core"]:GetJobPlayer() == "lssd" then
