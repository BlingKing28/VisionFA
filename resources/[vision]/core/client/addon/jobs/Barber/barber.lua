...
function LoadBarber()
    ...
    CreateThread(function()
        ...
        if p:getJob() == "barber" then
            ...
            zone.addZone("stockage_barber", vector3(140.833, -1704.037222969, 28.291856765747),
        ...
        elseif p:getJob() == "barber2" then
            ...
            zone.addZone("stockage_barber", vector3(-810.15179443359, -179.76550292969, 36.56893157959),
                "Appuyer sur ~INPUT_CONTEXT~ pour ouvrir le stockage", function()
                    OpenInventorySocietyMenu() -- TODO: fini le menu society
                end, false, 27, -- Id / type du marker
                0.3, -- La taille
        ...
        if not openRadial then
            ...
            CreateThread(function()
                SendNuiMessage(json.encode({
                    ...
                    }, title = ((p:getJob() == "barber") and "FILIPO CISO") or ((p:getJob() == "barber2") and "O'Sheas") }
                }));
            end)
        else
            openRadial = false
