...
DataToSendConcess = {
    buttons= {
        { -- OK
            ...
            image = "https://media.discordapp.net/attachments/498529074717917195/1144389574408278068/image.png",
        ...
        { -- OK
            ...
            --hoverStyle= 'fill-black stroke-black'
            image = "https://media.discordapp.net/attachments/498529074717917195/1144390927226507406/image.png",
            type = 'coverBackground',
            hoverStyle = 'stroke-black',
        },
        { -- OK
            ...
            --hoverStyle= 'fill-black stroke-black'
            image = "https://media.discordapp.net/attachments/498529074717917195/1144389799558529135/image.png",
            type = 'coverBackground',
            hoverStyle = 'stroke-black',
        },
        { -- OK
            ...
            --image= 'assets/svg/concess/sport.svg',
            --hoverStyle= 'fill-black stroke-black'
            image = "https://media.discordapp.net/attachments/498529074717917195/1144390023525974066/image.png",
            type = 'coverBackground',
            hoverStyle = 'stroke-black',
        },
        { -- OK
            ...
            --image= 'assets/svg/concess/sport.svg',
            --hoverStyle= 'fill-black stroke-black'
            image = "https://media.discordapp.net/attachments/498529074717917195/1144390096309714977/image.png",
            type = 'coverBackground',
            hoverStyle = 'stroke-black',
        },
        { -- OK
            ...
            --image= 'assets/svg/concess/car.svg',
            --hoverStyle= 'fill-black stroke-black'
            image = "https://media.discordapp.net/attachments/498529074717917195/1144390192862613644/image.png",
            type = 'coverBackground',
            hoverStyle = 'stroke-black',
        },
        { --OK
            ...
            --image= 'assets/svg/concess/car.svg',
            --hoverStyle= 'fill-black stroke-black'
            image = "https://media.discordapp.net/attachments/498529074717917195/1144390316049313842/image.png",
            type = 'coverBackground',
            hoverStyle = 'stroke-black',
        },
        { --OK
            ...
            --image= 'assets/svg/concess/car.svg',
            --hoverStyle= 'fill-black stroke-black'
            image = "https://media.discordapp.net/attachments/498529074717917195/1144390424010694767/image.png",
            type = 'coverBackground',
            hoverStyle = 'stroke-black',
        },
        {--OK
            ...
            --image= 'assets/svg/concess/car.svg',
            --hoverStyle= 'fill-black stroke-black'
            image = "https://media.discordapp.net/attachments/498529074717917195/1144390527379329134/image.png",
            type = 'coverBackground',
            hoverStyle = 'stroke-black',
        },
        { --OK
            ...
            --image= 'assets/svg/concess/car.svg',
            --hoverStyle= 'fill-black stroke-black'
            image = "https://media.discordapp.net/attachments/498529074717917195/1144389677026123928/image.png",
            type = 'coverBackground',
            hoverStyle = 'stroke-black',
        },
        {  --OK
            ...
            --hoverStyle= 'fill-black stroke-black'
            image = "https://media.discordapp.net/attachments/498529074717917195/1144391683073659052/image.png",
            type = 'coverBackground',
            hoverStyle = 'stroke-black',
        }
    },
    ...
    headerImage= 'assets/headers/header_lsmotors.png',
